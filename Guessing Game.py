...
lblInst = tk.Label(window, text = "Guess a number from 1 to 6")
...
for row in range(0, 2):
    for col in range(0, 3):
        i = row * 3 + col  # convert 2d index to 1d. 5= total number of columns
        buttons[i].grid(row=row+7, column=col)
